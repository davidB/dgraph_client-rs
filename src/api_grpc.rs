...
pub trait Dgraph {
    fn query(&self, ctx: ::grpcio::RpcContext, req: super::api::Request, sink: ::grpcio::UnarySink<super::api::Response>);
    fn mutate(&self, ctx: ::grpcio::RpcContext, req: super::api::Mutation, sink: ::grpcio::UnarySink<super::api::Assigned>);
    fn alter(&self, ctx: ::grpcio::RpcContext, req: super::api::Operation, sink: ::grpcio::UnarySink<super::api::Payload>);
    fn commit_or_abort(&self, ctx: ::grpcio::RpcContext, req: super::api::TxnContext, sink: ::grpcio::UnarySink<super::api::TxnContext>);
    fn check_version(&self, ctx: ::grpcio::RpcContext, req: super::api::Check, sink: ::grpcio::UnarySink<super::api::Version>);
}
